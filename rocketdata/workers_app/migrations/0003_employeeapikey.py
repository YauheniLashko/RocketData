# Generated by Django 4.0.3 on 2022-03-22 08:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('workers_app', '0002_alter_employee_chief'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api_keys', to='workers_app.employee')),
            ],
            options={
